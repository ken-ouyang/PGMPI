...
def runner(dataset):
  ...
  if pin_hole: 
    ...
    --database_path " + dataset + "/database.db \
    --image_path " + dataset + "/images \
    --ImageReader.mask_path " + dataset + "/masks \
    --ImageReader.single_camera 1\
  ...
  if not hierarchical:
    ...
    # --database_path " + dataset + "/database.db " \
    # "--SiftMatching.guided_matching 1 \
    #  --SequentialMatching.vocab_tree_path /home/houyang/data/style_mpi/colmap_vocab/vocab_tree_flickr100K_words256K.bin" \
    # )
    ...
    cmd("colmap vocab_tree_matcher \
      --VocabTreeMatching.vocab_tree_path /home/houyang/data/style_mpi/colmap_vocab/vocab_tree_flickr100K_words256K.bin \
      --SiftMatching.guided_matching 1 \
      --database_path "+ dataset + "/database.db")
    # cmd("colmap exhaustive_matcher \
    # --database_path " + dataset + "/database.db " \
    ...
    cmd("colmap point_triangulator \
      ...
      --output_path " + dataset + "/sparse/tri")
    
    # merge the colmap if needed
